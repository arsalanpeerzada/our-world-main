...
class ChessGamePage extends StatefulWidget {
  const ChessGamePage({super.key, required this.streamingRequestsModelList});
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset(
                      'assets/images/chess.png', // Replace with your actual image path
                      fit: BoxFit.cover,
                    ),
                  ),
                  const SizedBox(height: 40),
                  ...
                  //       ),
                  //       Text(
                  //         _currentValue.toString(),// Replace with your price

...
class StreamingRequestsScreen extends StatelessWidget {
  ...
  StreamingRequestsScreen(String userId, List<Followers> followersRequestList,
      String streamingToken, String channel, String chatToken) {
          ...
          () => controller.followersList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return requestRowItem(
                        controller.followersList.value[index], index);
                  },
                )
              : Container(
                  height: 300,
    ...
    return InkWell(
      onTap: () {
        controller.sendLiveStreamingRequest(
            follower,
            controller.streamingToken.value,
            controller.channelName.value,
            controller.chatToken.value,
          "",
          0
        );
      },
